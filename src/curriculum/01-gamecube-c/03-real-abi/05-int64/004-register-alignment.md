...
rule that a 64-bit argument's register pair must begin on an odd register: r3,
r5, r7, or r9.
...
unused. That's why `return y + 10;` operates on `r5:r6` and not the `r4:r5` you
...
Write `func_803350bc` to reproduce the assembly above.

<!-- solution -->
```c
u64 func_803350bc(u32 a, u64 b) {
    return b + 5;
}
```
