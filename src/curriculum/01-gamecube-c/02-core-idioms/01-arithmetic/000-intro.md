...
That's the introduction behind you. You can read a line of PowerPC, you know
where a function's arguments and return value live, and — as of the last
chapter — you can recover a signature from nothing but the target in front of
you.

Now the real work starts. This tier, **Core idioms**, is a tour of the shapes C
...
- the tricks the compiler plays — a multiply or divide by a constant that
  becomes a **shift**, a division with **no divide instruction** at all, and a
  **modulo** the hardware doesn't have,
