...
const variantClasses: Record<Variant, string> = {
  ...
  warning: "bg-warn/15 theme-light:bg-amber-500/15 text-warn theme-light:text-amber-500",
};

export function Pill({ text, icon: Icon, loading = false, variant }: Props) {
  const base =
    "flex justify-center items-center gap-1 rounded-full px-2 py-0.5 text-2xs font-semibold transition-colors duration-500";
