...
export function LessonSolutionBox({ solution, shown, onToggle, onUse }: Props) {
  ...
  if (confirming) {
    return (
      <div className="animate-slide-up-fade mt-4 rounded-lg bg-warn/[0.09] theme-light:bg-amber-500/[0.09] px-3 py-2.5">
        ...
        <div className="mt-2 flex items-center gap-2">
          <button
            ...
            className="rounded-md border border-warn/40 px-2.5 py-1 text-2xs font-semibold text-warn theme-light:text-amber-500 transition hover:bg-warn/10 theme-light:hover:bg-amber-500/10"
          >
            Reveal anyway
          </button>
